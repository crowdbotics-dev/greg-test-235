"""
Django settings for greg_test_235 project.
...
ROOT_URLCONF = 'greg_test_235.urls'
...
WSGI_APPLICATION = 'greg_test_235.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "greg_test_235 API",
    "DESCRIPTION": "API documentation for greg_test_235 App",
    "VERSION": "v1",
}
